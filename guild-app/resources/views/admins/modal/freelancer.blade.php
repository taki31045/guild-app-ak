        ...
        <div class="modal-dialog">
            <div class="modal-content border-success">
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('admin.freelancer.activate', $freelancer->user->id) }}" method="post">
                        @csrf
                        @method('PATCH')
    ...
    <div class="modal fade" id="deactivate-user-{{ $freelancer->user->id }}">
        <div class="modal-dialog">
            <div class="modal-content border-danger">
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('admin.freelancer.deactivate', $freelancer->user->id) }}" method="post">
                        @csrf
                        @method('DELETE')

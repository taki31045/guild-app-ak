            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li> <a href="{{ route('company.dashboard')}}" class="text-decoration-none text-white">On-Going</a></li>
                        <li class="ms-4"> <a href="{{ route('company.test')}}" class="text-decoration-none text-white">Job list</a></li>
